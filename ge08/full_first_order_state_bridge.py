#!/usr/bin/env python3
"""GE08 full first-order eta=0 state bridge audit.
...
No physics equation is modified here.
"""
...
def main():
    ...
    bridge_gates={
        ...
        "alpha_prime_identity_abs_or_rel_le_1e12":bool(alpha_id_err<=TOL),
        "phi_prime_dy_identity_abs_or_rel_le_1e12":bool(phi_id_err<=TOL),
    ...
    if not bridge_pass:
        classification="GE08_FULL_FIRST_ORDER_STATE_BRIDGE_FAIL"
    elif pressureless_ready:
        classification="GE08_FULL_FIRST_ORDER_STATE_BRIDGE_H3_READY"
    else:
        classification="GE08_FULL_FIRST_ORDER_STATE_BRIDGE_PASS_MATTER_INCOMPLETE"

    result={
        "classification":classification,
        "predata_classification":"GE08_PREDATA_FULL_FIRST_ORDER_STATE_BRIDGE_AUDIT",
        "scope":"Diagnostic eta=0 accepted-source-grid first-order state bridge and exact pressureless-matter completeness audit; no Z20/Z21 solve.",
        "trace_counts":{
        ...
        "bridge_errors":{
            ...
            "alpha_prime_identity_abs_or_rel_max":alpha_id_err,
            "phi_prime_identity_abs_or_rel_max":phi_id_err,
        ...
        "project_boundary":{
            ...
            "full_CLASS_pressureless_H3_ready":bool(bridge_pass and pressureless_ready),
            "Z20_solve_licensed_on_full_CLASS_reference":bool(bridge_pass and pressureless_ready),
            "finite_eta_licensed":False,
        },
        "claim_boundary":"GE08 certifies only the first-order bridge and exact matter-completeness status. It does not solve Z20/Z21, introduce finite eta, or establish nonlinear-collapse/observational claims.",
    }
