...
cd "$ROOT"
mkdir -p results
# Instrumented corrected CLASS exports alpha_aest/E_aest; exact background evaluation removes endpoint-only interpolation dependence. Physics and gates unchanged.
...
python -u nl1c6d2c6a/physical_time_scalar_current_integrator_v5.py \
