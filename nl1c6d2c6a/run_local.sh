...
cd "$ROOT"
mkdir -p results
# Instrumented corrected CLASS exports alpha_aest/E_aest; exact background evaluation and exact fixed-grid endpoint bookkeeping only. Physics and preregistered gates unchanged.
...
python -u nl1c6d2c6a/physical_time_scalar_current_integrator_v6.py \
