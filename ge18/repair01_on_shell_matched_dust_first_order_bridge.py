#!/usr/bin/env python3
"""GE18 Repair01 on-shell matched-dust first-order bridge.
...
def main():
    ...
    result={
        ...
        "predata_classification":"GE18_REPAIR01_PREDATA_NATIVE_PROVENANCE_GATE",
        "scope":"GE18 Repair01: same frozen on-shell pressureless standard-matter surrogate. Native provenance gates determine PASS/FAIL; the mixed 64-node cross-interpolation quantity is diagnostic only.",
        "input_provenance":{
            ...
            "mixed_64node_cross_interpolation_diagnostic_abs_or_rel_max":max(metric_bg_errors),
        },
        ...
        "historical_GE18_classification":"GE18_ON_SHELL_MATCHED_DUST_FIRST_ORDER_BRIDGE_FAIL",
        "repair01_change":"Only the mixed-representation 64-node cross-interpolation sanity quantity is diagnostic-only; no frozen dust equation, threshold, C value, matching rule, or GE07 map changed.",
        "claim_boundary":"Repair01 PASS certifies the internally consistent pressureless Z10 matter surrogate and GE07 variable map. Its distance from full standard CLASS matter remains an explicit systematic to propagate through the later reduced-H3 Z20 envelope.",
    }
