...
B5_PREREG_COMMIT='13a1e33cc170688441fe979a277c3826952de5e0'
B5_INITIAL_LOCK_COMMIT='b0c03b610522be1c6b676eaa06c836e5e4c9f9a0'
B5_INITIAL_RUN_HEAD='7806749a5d28c63887cd0207e366e858cdaf8c99'
B5_INITIAL_FAIL_FREEZE_COMMIT='0c7c6fcc736c2f218b5704d2c6676a20c7944861'
REPAIR01_PREREG_COMMIT='33a89e4fce0701bf69923e0cfe60ca5aa4751ab4'
REPAIR01_IMPLEMENTATION_COMMIT='d88513127f694a7c1334f8ba6d7d8b3189680074'
REPAIR01_LOCK_COMMIT='73214424334d46b6c2e3ca07f65949317d5c663d'

R19C4_FREEZE_BLOB='cd36b4d3d457b22a63054b78b9930c02ca117a37'
B5_PREREG_BLOB='f03e657c5f3ec3eebd4cffef65083dc789182103'
B5_INITIAL_LOCK_BLOB='75eb60344353929941886e270a453ce047c173bc'
B5_INITIAL_FAIL_FREEZE_BLOB='a9e3f3e5594d7111c62553e1f28b62d0d3cd1d97'
REPAIR01_PREREG_BLOB='4645bb34bad3fb01b6bd4ba0f72da067e38943b9'
REPAIR01_IMPLEMENTATION_BLOB='3427a5e356230020a9418b320fbdecd2ec9fee1f'
REPAIR01_LOCK_BLOB='e1398401391adda776c662cb0669488a8da004d8'
...
OUT='results/nl1c7b5_repair01_regular_center_source_limit.json'
STATE='results/nl1c7b5_conservative_integral_initial_states.npz'
LOG='results/nl1c7b5_repair01_regular_center_source_limit.log'
...
for c in   "$R19C4_FREEZE_COMMIT"   "$B5_PREREG_COMMIT"   "$B5_INITIAL_LOCK_COMMIT"   "$B5_INITIAL_RUN_HEAD"   "$B5_INITIAL_FAIL_FREEZE_COMMIT"   "$REPAIR01_PREREG_COMMIT"   "$REPAIR01_IMPLEMENTATION_COMMIT"   "$REPAIR01_LOCK_COMMIT"
do
...
check_blob docs/nl1c7b5_predata_conservative_integral_initial_data.md "$B5_PREREG_BLOB"
check_blob docs/nl1c7b5_conservative_integral_initial_data_implementation_lock.md "$B5_INITIAL_LOCK_BLOB"
check_blob docs/nl1c7b5_initial_implementation_fail_result_freeze.md "$B5_INITIAL_FAIL_FREEZE_BLOB"
check_blob docs/nl1c7b5_repair01_predata_regular_center_source_limit.md "$REPAIR01_PREREG_BLOB"
check_blob nl1c7b/conservative_integral_initial_data_b5.py "$REPAIR01_IMPLEMENTATION_BLOB"
check_blob docs/nl1c7b5_repair01_regular_center_source_limit_implementation_lock.md "$REPAIR01_LOCK_BLOB"
...
echo 'NL1C7B5_REPAIR01_REGULAR_CENTER_LOCK_PASS'
echo "HEAD=$(git rev-parse HEAD)"
echo "PARENT_B5_FAIL_JSON_SHA256=6f59e45621d4895ee8fbb4ce125943fcd2939a534a7266fbebae4759190f79bc"
...
p=pathlib.Path('results/nl1c7b5_repair01_regular_center_source_limit.json')
...
for r in d['case_rows']:
    ...
    print('scale=',r['scale_hinv_Mpc'],'Nr=',r['Nr'],
          ...
          '| initial_finite=',r.get('initial_conservative_residual_finite'),
