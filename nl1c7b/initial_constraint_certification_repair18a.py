...
def main():
    ...
    h18=sha256_file(a.repair18_json)
    ...
    g17=p17.get('gates',{})
    g18=p18.get('gates',{})
    repair18_frozen_fail=bool(
        p18.get('classification')==R18_CLASS
        and len(g18)==7
        and g18.get('R18_G1_frozen_provenance') is True
        and g18.get('R18_G2_unprojected_lambda1_reproduction') is True
        and g18.get('R18_G3_canonical_nonlinear_solve_closure') is False
        and g18.get('R18_G4_second_order_correction_scaling') is True
        and g18.get('R18_G5_two_grid_correction_amplitude_control') is True
        and g18.get('R18_G6_field_freeze_invariant') is True
        and g18.get('R18_G7_claim_boundary') is True
    )
    g1=bool(
        h15j==R15A_JSON_SHA256 and h15n==R15A_NPZ_SHA256
        and h16==R16_JSON_SHA256 and h17==R17_JSON_SHA256
        and h18==R18_JSON_SHA256 and repair18_frozen_fail
    ...
    coordinate_equivalence={
        'physical_projection_pair_unchanged':True,
        'physical_Rt_bounds_unchanged':True,
        'canonical_branch_unchanged':True,
        'historical_threshold_unchanged':True,
        'solver_coordinate':'q_Rt = delta_Rt/(a H R_s)',
    }
    g7=bool(not any(claim_boundary.values()) and repair18_frozen_fail)

    gates={
        'R18A_G1_frozen_provenance':g1,
        'R18A_G2_unprojected_lambda1_reproduction':g2,
        'R18A_G3_canonical_nonlinear_solve_closure':g3,
        'R18A_G4_second_order_correction_scaling':g4,
        'R18A_G5_two_grid_correction_amplitude_control':g5,
        'R18A_G6_field_freeze_invariant':g6,
        'R18A_G7_coordinate_equivalence_and_claim_boundary':g7,
    }

    impl_ok=bool(g1 and g2 and g6 and g7)
    if not impl_ok:
        classification='NL1C7B4_REPAIR18A_IMPLEMENTATION_FAIL'; rc=2
    elif not (g3 and g4 and g5):
        classification='NL1C7B4_REPAIR18A_DIMENSIONLESS_RT_COORDINATE_FEASIBILITY_FAIL'; rc=2
    else:
        classification='NL1C7B4_REPAIR18A_DIMENSIONLESS_RT_COORDINATE_FEASIBILITY_PASS'; rc=0

    result={
        'classification':classification,
        'scope':'Repair18a coordinate-only feasibility repair of the same exact nonlinear eta=0 L/R_t projection; q_Rt is dimensionless and no official state artifact is written.',
        'provenance':{
            ...
            'repair18_result_freeze_commit':'ff3517dc9a5d394339d20e82b3dd4158346f5498',
            'repair18a_prereg_commit':'7472d7be86c4de2b9f8f74463bad557757d0b60c',
        },
        ...
        'solver_lock':{
            ...
            'yL_bounds':[-0.5,0.5],
            'qRt_bounds':[-0.5,0.5],
            'qRt_definition':'delta_Rt/(a H R_s)',
            'physical_deltaRt_over_aHRs_bounds':[-0.5,0.5],
            'multistart':False,
        },
