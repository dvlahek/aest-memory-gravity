...
def main():
    ...
    for scale in b4.SCALES:
        ...
        rank=int(np.count_nonzero(s>rank_tol))
    ...
    gates={
        'R18D_G1_exact_frozen_provenance':g1,
        'R18D_G2_exact_Repair18c_nullspace_reproduction':bool(g2),
        'R18D_G3_exact_candidate_set':bool(g3),
        'R18D_G4_complete_finite_transversality_audit':bool(g4),
        'R18D_G5_at_least_one_globally_transverse_pair':g5,
        'R18D_G6_deterministic_selection_rule':g6,
        'R18D_G7_claim_boundary':g7,
    }
    if all(gates.values()):
        classification='NL1C7B4_REPAIR18D_NULLSPACE_TRANSVERSALITY_AUDIT_PASS'; rc=0
    else:
        classification='NL1C7B4_REPAIR18D_IMPLEMENTATION_FAIL'; rc=2

    result={
        'classification':classification,
        'scope':'Repair18d basis-invariant transversality audit of five preregistered linear condition pairs against the frozen two-dimensional null space.',
        'provenance':{
            **hashes,
            'repair18c_result_freeze_commit':'c29ce80b65435b60882bd5140a9cfe648b4f3a5b',
            'repair18d_prereg_commit':'2f07ab2a5ffb905427f48c681f39b1a0be8221e3',
        },
        'domain':{
