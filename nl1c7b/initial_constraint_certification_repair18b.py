...
def main():
    ...
    if not (provenance_ok and finite_all and len(rows)==3 and boundary_ok):
        classification='NL1C7B4_REPAIR18B_IMPLEMENTATION_FAIL'
        rc=2
    elif not structure_match_all:
        classification='NL1C7B4_REPAIR18B_SPARSE_JACOBIAN_STRUCTURE_MISMATCH'
        rc=2
    elif not full_rank_all:
        classification='NL1C7B4_REPAIR18B_LOCAL_PROJECTION_RANK_DEFICIENCY'
        rc=2
    else:
        classification='NL1C7B4_REPAIR18B_FULL_RANK_JACOBIAN_DIAGNOSTIC_PASS'
        rc=0

    result={
        'classification':classification,
        'scope':'Repair18b numerical Jacobian-fidelity and local-rank diagnostic for the frozen Repair18a L/R_t projection; no corrected state artifact.',
        'provenance':{
            **hashes,
            'repair18a_result_freeze_commit':'8cfce926a9075d77dd73c5bb5242c9d3e26b74ad',
            'repair18b_prereg_commit':'ff79eb82b14ff2c86a2d02c3b05fc60937a7801d',
        },
