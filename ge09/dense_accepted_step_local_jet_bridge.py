...
def main():
    ...
    saved={k:os.environ.get(k) for k in (
        "AEST_DENSE_JET_TRACE_FILE","AEST_FULL_STATE_TRACE_FILE",
        "AEST_OFFLINE_TRACE_FILE","AEST_TANGENT_FORCE_FILE",
        "AEST_TANGENT_LAMBDA","OMP_NUM_THREADS")}
    try:
        os.environ["AEST_DENSE_JET_TRACE_FILE"]=str(dense.resolve())
        os.environ["AEST_FULL_STATE_TRACE_FILE"]=str(source.resolve())
        os.environ.pop("AEST_OFFLINE_TRACE_FILE",None)
    ...
    gates={
        ...
        "dense_trace_vs_CLASS_get_perturbations_abs_or_rel_le_1e12":bool(class_err<=TRACE_CLASS_MAX),
    ...
    result={
        ...
        "predata_classification":"GE09_PREDATA_DENSE_ACCEPTED_STEP_LOCAL_JET_BRIDGE",
        "scope":"Dense successful-step first-order local-jet representation for the GE06 scalar-longitudinal Q generator only; matter closure and Z20 remain separate.",
        "trace":{
            ...
            "trace_vs_CLASS_get_perturbations_abs_or_rel_max":class_err,
