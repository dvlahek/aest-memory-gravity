...
test "$(git rev-parse HEAD:ge19/repair38_frozen_source_radau_substep_localization.py)" = "fbab2cd31cfcb69c21c3e066e6d8d17844369d32"
test "$(git rev-parse HEAD:.github/workflows/ge19-repair38-prelock-audit.yml)" = "38f4afee0384f4f5b3de870e4adc2c1187442137"
...
test "$(git rev-parse HEAD:docs/ge19_repair38_repair01_endpoint_domain_implementation_lock.md)" = "69936a8db68e305d6a82e8f7279dd450436438d1"
...
echo GE19_REPAIR38_REPAIR01_LOCK_PASS
...
echo GE19_REPAIR38_REPAIR01_LOCAL_PREEXECUTION_AUDIT_PASS
...
echo GE19_REPAIR38_REPAIR01_FROZEN_INPUTS_PASS
...
FULL="results/ge19_repair38_repair01_frozen_source_radau_substep_localization_FULL.log"
rm -f "$JSON" "$NPZ" "$FULL"
...
if [[ "$rc" -eq 0 && -s "$JSON" ]]; then
  echo GE19_REPAIR38_REPAIR01_DIAGNOSTIC_COMPLETE
elif [[ "$rc" -eq 3 && -s "$JSON" ]]; then
  echo GE19_REPAIR38_REPAIR01_IMPLEMENTATION_REPRODUCTION_FAIL
else
  echo GE19_REPAIR38_REPAIR01_IMPLEMENTATION_OR_EXECUTION_FAILURE
fi
exit "$rc"
