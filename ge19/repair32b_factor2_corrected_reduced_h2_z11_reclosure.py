#!/usr/bin/env python3
"""GE19 Repair32B — factor-two corrected reduced H2/Z11 reclosure.
...
def main():
    ...
    if missing:
        raise RuntimeError("missing frozen Repair32B inputs: "+", ".join(missing))
    ...
    mod6_frozen=r7.load_frozen_generator(
        ROOT/"ge06/analytic_aest_directional_source_generator.py","ge06r32b"
    )
    mod6=r7.build_stable_ge06_generator_v2(mod6_frozen)
    mod7=r7.load_frozen_generator(
        ROOT/"ge07/pressureless_matter_directional_source_generator.py","ge07r32b"
    )
    ...
    report={
        ...
        "predata_classification":"GE19_REPAIR32B_PREDATA_FACTOR2_CORRECTED_REDUCED_H2_Z11_RECLOSURE",
        ...
        "Repair31_style_diagnostics_report_only":{\n            "state_time_control":diagnostic_state_rows,\n            "operator_control":diagnostic_operator_rows,\n            "R2_reference_aether_scalar_corrected_source_relative_L2_max":r2_reference_driven_residual_max,\n            "does_not_replace_original_Repair30_gates":True,\n        },\n        "gates":gates,
        ...
        "claim_boundary":"Repair32B changes exactly one physics/dictionary item relative to Repair30: the exact Repair32A GE05-to-GE06 raw-residual scale 1->2. All original Repair30 science gates remain unchanged. Repair30 is not relabelled. Repair32B does not solve H4/Z21, introduce finite eta, certify full-species nonlinear evolution, lensing, or observations.",
    }
