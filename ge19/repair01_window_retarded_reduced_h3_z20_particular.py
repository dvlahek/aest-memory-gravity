#!/usr/bin/env python3
"""GE19 Repair01 window-retarded reduced-H3 Z20 particular solve.
...
def main():
    ...
    if not (provenance_pass and stage_A_pass):
        result={
            "classification":"GE19_REPAIR01_WINDOW_RETARDED_REDUCED_H3_Z20_PARTICULAR_FAIL",
...
if __name__=="__main__":
    try:
        ...
        # Keep Repair01 implementation failures distinct from science FAIL.
        print(json.dumps({
            "classification":"GE19_REPAIR01_WINDOW_RETARDED_REDUCED_H3_Z20_PARTICULAR_IMPLEMENTATION_FAIL",
            "error":repr(exc),
        },indent=2))
        raise
