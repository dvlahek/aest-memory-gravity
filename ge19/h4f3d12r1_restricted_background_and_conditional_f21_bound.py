        ...
        for nt,lab in ((128,"primary"),(64,"control")):
            ...
            for tag in TAGS:
                ...
                for scheme in SCHEMES:
                    ...
                    floating_scale=(l2(np.asarray(z[prefix+scheme+"_component_L_GE06_local"],float))
                                    +l2(np.asarray(z[prefix+scheme+"_component_L_GE06_minus_dt_pLt"],float))
                                    +l2(np.asarray(z[prefix+scheme+"_component_L_Lambda"],float))
                                    +1e-30)
